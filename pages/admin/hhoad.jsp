            ...
            <div class="container-fluid am-cf">
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                        <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 脚本重载管理 <small>ELSTP STUDIO</small></div>
                    </div>
                ...
                <div style="margin-left: 20%;" class="row am-cf">
                    ...
                    <div class="am-form-group">
                 <p>从禁令文件中删除过期的禁令</p>
                 <button onclick="scriptcmd(1);" type="button" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn">删除过期的禁令</button>
                <hr>
                <p>重新载入禁令文件</p>
                <button onclick="scriptcmd(2);" type="button" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn">禁令重载</button>
                 <hr>
                 <p>重新载入createvehicle.txt，remoteexec.txt和publicvariable.txt</p>
                <button onclick="scriptcmd(3);" type="button" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn">重载过滤器脚本</button>
                <hr>
                <p>重新载入scripts.txt</p>
                <button onclick="scriptcmd(4);" type="button" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn">重载脚本</button>
                <hr>
                <p>重新加载由config选项加载的服务器配置文件。</p>
                <button onclick="scriptcmd(5);" type="button" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn">重载设置脚本</button>
                    </div>
...
<script>
	function scriptcmd(args){
		...
		switch (args){
			...
			$.ajax({
				url:'<%=basePath %>login/load.arma?cmd='+cmd,
				type:'post',
				dataType:'json',
