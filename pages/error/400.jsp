...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    ...
    <body id="page">
        <ul class="cb-slideshow">
            <li><a href="http://kissanime.ru/Anime/Koe-no-Katachi"><span>Image 01</span><div><h3>无效的请求 400</h3></div></a></li>
            <li><span>Image 02</span><div><h3>服务器娘不认你啦!</h3></div></li>
            <li><span>Image 03</span><div><h3>请联系站长邮箱</h3></div></li>
            <li><span>Image 04</span><div><h3>elstpserver@qq.com</h3></div></li>
            <li><span>Image 05</span><div><h3>服务器无法识请求</h3></div></li>
            <li><span>Image 06</span><div><h3>400 – Bad Request</h3></div></li>
        </ul>
